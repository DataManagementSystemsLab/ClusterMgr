...
/**
 *	Parent class for differents MOTP type
 *
 * @param options {object} list of options
 * @constructor
 */
const MOTP = function (options) {
	this.options = options;
	this.algorithms = ['sha1', 'sha256','sha512'];
};

/**
 * Return the options for the particular MOTP
 * @returns {*}
 */
MOTP.prototype.getOptions = function () {
	return this.options;
};
 ...
 * 		sha512: 64
 */
MOTP.prototype.hashSize = function (algorithm) {
...
MOTP.prototype.tokenize = function(options) {
	...
	//console.log("hash"+hash.toString(2));
