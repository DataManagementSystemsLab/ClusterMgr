...
Create table if not exists owcluster.vms (id int primary key AUTO_INCREMENT, ipaddr VARCHAR(15) unique, memory int, vcpu int,  macaddr varchar(30),hostname varchar(30), disk_image varchar(40), location varchar(10));
