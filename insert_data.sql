...
insert into vms(indx,hostname,vcpu,memory,ipaddr,macaddr,location) values (10,'db',5,10,'10.100.3.10','ae:52:03:00:04:0a', 'owhpc-01' );
insert into vms(indx,hostname,vcpu,memory,ipaddr,macaddr,location) values (20,'pchau1',2,4, '10.100.6.50','ae:52:06:00:00:50', 'owhpc-01' );
insert into vms(indx,hostname,vcpu,memory,ipaddr,macaddr,location) values (21,'emastroc',2,4,'10.100.6.51','ae:52:06:00:00:51','owhpc-01' );
insert into vms(indx,hostname,vcpu,memory,ipaddr,macaddr,location) values (22,'vyashaev' ,2,4,'10.100.6.52','ae:52:06:00:00:52','owhpc-01');
insert into vms(indx,hostname, vcpu,memory,ipaddr,macaddr,location) values (23,'kthomp39',2,4,'10.100.6.53' ,'ae:52:06:00:00:53','owhpc-01');
 insert into vms(indx,hostname, vcpu,memory,ipaddr,macaddr,location) values (24,'jcozzoli',2,4,'10.100.6.54','ae:52:06:00:00:54', 'owhpc-01' );
insert into vms(indx,hostname,vcpu,memory,ipaddr,macaddr,location) values (25,'cpeter16',2,4,'10.100.6.55','ae:52:06:00:00:55', 'owhpc-01' );
